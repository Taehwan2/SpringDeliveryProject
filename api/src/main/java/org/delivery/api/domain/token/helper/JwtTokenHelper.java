...
public class JwtTokenHelper implements TokenHelperIfs {
    ...
    public TokenDto issueAccessToken(Map<String, Object> data) {
        ...
        var jwtToken = Jwts.builder().signWith(key, SignatureAlgorithm.HS256).setClaims(data).setExpiration(expiredAt)
                .compact();
        return TokenDto.builder().token(jwtToken).expiredAt(expiredLocalDateTime).build();
    }
